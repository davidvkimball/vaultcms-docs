...
[Bases CMS](https://community.obsidian.md/plugins/bases-cms) lets you treat a grid of content like a content management system. Requires the [Bases](https://help.obsidian.md/bases) core plugin to be enabled.
