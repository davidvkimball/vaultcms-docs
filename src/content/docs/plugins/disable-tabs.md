...
![Disable Tabs preview](attachments/disable-tabs.png)

[Disable Tabs](https://community.obsidian.md/plugins/disable-tabs) is off by default, but if enabled, opening or closing tabs will always replace the current tab with the new one, even replacing pinned tabs.
