...
![Property Over File Name preview](attachments/property-over-file-name.png)

[Property Over File Name](https://community.obsidian.md/plugins/property-over-file-name) lets you use a specified property (like `title`) as the primary label instead of the file name when linking, searching, or displaying notes.
