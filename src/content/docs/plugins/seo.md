...
![Search Engine Optimization preview](attachments/seo.png)

The [Search Engine Optimization](https://community.obsidian.md/plugins/seo) plugin provides a comprehensive audit of your content for search engine rankings and AI parsing.
